...
console.info('%c 来源 %c', `${labelStyle}background:#986db2;`, '', 'https://github.com/chanshiyucx/aurora')
console.info('%c 本站 %c', `${labelStyle}background:#00bfff;`, '', 'https://github.com/lin1heart/aurora-lin')
